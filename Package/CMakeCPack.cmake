...
# 包名。建议用英文。
set(CPACK_PACKAGE_NAME "LunarCalendar")
...
set(CPACK_PACKAGE_DESCRIPTION "农历日历")
#set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_SOURCE_DIR}/README.md")
# 设置简短的描述摘要。
# 如果 CMAKE_PROJECT_DESCRIPTION 设置，用于默认值，
# 否则默认值由 CMAKE 基于 CMAKE_PROJECT_NAME 产生.
#SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "农历日历")

#set(CPACK_RESOURCE_FILE_WELCOME )
set(CPACK_RESOURCE_FILE_README "${CMAKE_SOURCE_DIR}/README.md")
set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_BINARY_DIR}/LICENSE.txt")
set(CPACK_PACKAGE_HOMEPAGE_URL "https://github.com/KangLin/LunarCalendar")
set(CPACK_PACKAGE_CONTACT "康 林 <kl222@126.com>")

set(CPACK_PACKAGE_INSTALL_DIRECTORY "LunarCalendar")
# 设置注册表健。仅用于 WINDOWS
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "LunarCalendar")
...
if(UNIX AND (NOT (MACOS AND APPLE)) AND (NOT ANDROID))
    ...
    # 设置 Source 字段
    set(CPACK_DEBIAN_PACKAGE_SOURCE LunarCalendar)
...
#set(CPACK_PACKAGE_EXECUTABLES "LunarCalendarApp" "农历日历")
#set(CPACK_CREATE_DESKTOP_LINKS "农历日历")
...
if(WIN32)
    ...
    set(CPACK_NSIS_INSTALLED_ICON_NAME "bin/LunarCalendarApp.exe")
    
    #显示在安装对话框中的包名
    set(CPACK_NSIS_PACKAGE_NAME "农历日历")
    
    #显示在“控制面板->程序->程序和功能->卸载或更改程序”
    set(CPACK_NSIS_DISPLAY_NAME "农历日历")
    set(CPACK_NSIS_HELP_LINK "https://github.com/KangLin/LunarCalendar/issues")
    set(CPACK_NSIS_URL_INFO_ABOUT "https://github.com/KangLin/LunarCalendar")
    set(CPACK_NSIS_CONTACT "康 林 <kl222@126.com>")
    
    # 设置开始菜单快捷方式。格式： "程序位置（相对于安装根目录）" "菜单名"
    # 与 CPACK_PACKAGE_EXECUTABLES 功能类似
    set(CPACK_NSIS_MENU_LINKS
        "bin/LunarCalendarApp.exe" "农历日历"
        "https://github.com/KangLin/LunarCalendar" "项目主页"
    )
    set(CPACK_NSIS_MUI_FINISHPAGE_RUN LunarCalendarApp.exe)
    # 建立桌面快捷方式
    set(CPACK_NSIS_CREATE_ICONS_EXTRA "
         CreateShortCut '$DESKTOP\\\\农历日历.lnk' '$INSTDIR\\\\bin\\\\LunarCalendarApp.exe'
         ")
    # Delete the Startup menu link after uninstallation
    set(CPACK_NSIS_DELETE_ICONS_EXTRA "
        Delete '$DESKTOP\\\\农历日历.lnk'
    ")
endif()
############### NSIS ###################
