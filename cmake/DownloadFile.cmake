...
# Usage samples:
#   _assert(MyLib_FOUND)
#   _assert(DEFINED MyLib_INCLUDE_DIRS)
macro(_assert)
  if(NOT (${ARGN}))
...
function(download)
  ...
  if(NOT EXISTS "${CACHE_CANDIDATE}")
    ...
    file(DOWNLOAD "${DL_URL}" "${CACHE_CANDIDATE}"
         ...
         STATUS status
         LOG __log)
    if(NOT SKIP_FILE_DOWNLOAD_DUMP)  # workaround problem with old CMake versions: "Invalid escape sequence"
...
")
      ...
      file(APPEND "${DOWNLOAD_WITH_CURL}" "curl --output \"${CACHE_CANDIDATE}\" \"${DL_URL}\"\n")
      file(APPEND "${DOWNLOAD_WITH_WGET}" "wget -O \"${CACHE_CANDIDATE}\" \"${DL_URL}\"\n")
      return()
    endif()
