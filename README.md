...
- linux
    + [LunarCalendar_v0.0.9.tar.gz](https://github.com/KangLin/LunarCalendar/releases/download/v0.0.9/LunarCalendar_v0.0.9.tar.gz)  
      The AppImage format executable can be run directly on the Linux system, see: https://appimage.org/  
      usage:
  
      1. Decompress. Copy LunarCalendar_v0.0.9.tar.gz to install dirctory, then decompress it:
      
                mkdir LunarCalendar
                cd LunarCalendar
                cp $DOWNLOAD/LunarCalendar_v0.0.9.tar.gz .
                tar xvfz LunarCalendar_v0.0.9.tar.gz
...
- ubuntu
    + [lunarcalendar_0.0.9_amd64.deb](https://github.com/KangLin/LunarCalendar/releases/download/v0.0.9/lunarcalendar_0.0.9_amd64.deb)  
      Deb installation package for Ubuntu

- windows
    + [LunarCalendar-Setup-v0.0.9.exe](https://github.com/KangLin/LunarCalendar/releases/download/v0.0.9/LunarCalendar-Setup-v0.0.9.exe)  
      Windows installation package, support for Windows xp and above


- android
    + [android-build-debug.apk](https://github.com/KangLin/LunarCalendar/releases/download/v0.0.9/android-build-debug.apk)  
